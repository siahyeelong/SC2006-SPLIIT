    ...
    return (
        <LocalizationProvider dateAdapter={AdapterDayjs}>
            ...
            >
                ...
                <DatePicker />
                <TextField label="Start Date" variant="filled" name="startDate" value={formData.startDate} onChange={handleChange} type="date" InputLabelProps={{ shrink: true }} />
                <TextField label="End Date" variant="filled" name="endDate" value={formData.endDate} onChange={handleChange} type="date" InputLabelProps={{ shrink: true }} />
