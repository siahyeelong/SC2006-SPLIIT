...
import { Box, Button, Chip, Dialog, DialogActions, DialogContent, DialogTitle, IconButton, Stack, Tooltip, Typography, useTheme } from '@mui/material';
            ...
            <Dialog open={open} onClose={handleClose} maxWidth="sm" fullWidth>
                ...
                <DialogContent>
                    ...
                    <Stack spacing={2} direction="row" alignItems="center" justifyContent={'center'}>
                        <IconButton href={shareLinks.whatsapp} target="_blank" rel="noopener noreferrer"><WhatsAppIcon /></IconButton>
                        <IconButton href={shareLinks.telegram} target="_blank" rel="noopener noreferrer"><TelegramIcon /></IconButton>
                        <IconButton href={shareLinks.instagram} target="_blank" rel="noopener noreferrer"><InstagramIcon /></IconButton>
                        <IconButton href={shareLinks.email} target="_blank" rel="noopener noreferrer"><EmailIcon /></IconButton>
                    </Stack>
                </DialogContent>
                <DialogActions sx={{ justifyContent: 'center' }}>
                    <Button onClick={handleClose} color="secondary" variant="contained">Start logging!</Button>
                </DialogActions>
            </Dialog>
            <SnackbarNotifs
